...
const roster = [
    ...
    {name: "Alex Lee", PPG: 6, teamName: "Holy Shot"},
    {name: "Caleb Choi", PPG: 6, teamName: "Holy Shot"},
    {name: "Joshua Park", PPG: 0, teamName: "Holy Shot"},
    {name: "Jonathan Ai", PPG: 5, teamName: "Holy Shot"},
    {name: "Brian Shin", PPG: 2, teamName: "Holy Shot"},
    {name: "Justin Kyung", PPG: 13, teamName: "Holy Shot"},
    ...
    //Ohana 
    {name: "Tim Jao", PPG: 21, teamName: "Ohana"},
    {name: "Chris Lee", PPG: 0, teamName: "Ohana"},
    {name: "Chris Youn", PPG: 13, teamName: "Ohana"},
    {name: "Justin Chung", PPG: 0, teamName: "Ohana"},
    {name: "Timothy Chuman", PPG: 10, teamName: "Ohana"},
    {name: "Christian Clark", PPG: 0, teamName: "Ohana"},
    {name: "Kevin Ra", PPG: 0, teamName: "Ohana"},
    {name: "Michael Ruan", PPG: 0, teamName: "Ohana"},
    {name: "Sam Kim", PPG: 10, teamName: "Ohana"},
    {name: "Katie Wong", PPG: 0, teamName: "Ohana"},

    //Triple Threats
    {name: "Joon Jang", PPG: 6, teamName: "Triple Threat"},
    {name: "Richard Yoon", PPG: 9, teamName: "Triple Threat"},
    {name: "Aaron Kim", PPG: 11, teamName: "Triple Threat"},
    {name: "Daniel Yoon", PPG: 10, teamName: "Triple Threat"},
    {name: "Eric Ko", PPG: 6, teamName: "Triple Threat"},
    {name: "Jin Park", PPG: 0, teamName: "Triple Threat"},
    {name: "Anthony Kim", PPG: 2, teamName: "Triple Threat"},
    {name: "Nathan Suh", PPG: 0, teamName: "Triple Threat"},
    {name: "Joshua Park", PPG: 2, teamName: "Triple Threat"},
    {name: "Angeline Quach", PPG: 0, teamName: "Triple Threat"},

    //Born Again Ballers
    {name: "Jonathan Mo", PPG: 0, teamName: "Born Again Ballers"},
    {name: "Jon Shen", PPG: 8, teamName: "Born Again Ballers"},
    {name: "Ethan Chien", PPG: 5, teamName: "Born Again Ballers"},
    {name: "Joshua Yoon", PPG: 3, teamName: "Born Again Ballers"},
    {name: "Daniel Weon", PPG: 0, teamName: "Born Again Ballers"},
    {name: "Enoch Chung", PPG: 2, teamName: "Born Again Ballers"},
    {name: "Brian Kim", PPG: 0, teamName: "Born Again Ballers"},
    {name: "Joseph Choi", PPG: 2, teamName: "Born Again Ballers"},
    {name: "Paul Ko", PPG: 0, teamName: "Born Again Ballers"},
    {name: "Peter Yu", PPG: 2, teamName: "Born Again Ballers"},
    ...
    //Short King of Kings
    {name: "Alex Chi", PPG: 3, teamName: "Short King of Kings"},
    {name: "Doulos Kun", PPG: 11, teamName: "Short King of Kings"},
    {name: "Jun Kim", PPG: 12, teamName: "Short King of Kings"},
    {name: "Jonathan Lin", PPG: 0, teamName: "Short King of Kings"},
    {name: "Joshua Park", PPG: 9, teamName: "Short King of Kings"},
    {name: "Edward Jung", PPG: 0, teamName: "Short King of Kings"},
    {name: "Stuart Mar", PPG: 0, teamName: "Short King of Kings"},
    {name: "Tae Kim", PPG: 9, teamName: "Short King of Kings"},
    ...
    //Justin & DK
    {name: "Justin Son", PPG: 16, teamName: "Overrated"},
    {name: "Daniel Kim", PPG: 9, teamName: "Overrated"},
    {name: "Nate Lee", PPG: 5, teamName: "Overrated"},
    {name: "Timothy Yu", PPG: 0, teamName: "Overrated"},
    {name: "Ivan Huang", PPG: 0, teamName: "Overrated"},
    {name: "Curtis Ahn", PPG: 0, teamName: "Overrated"},
    {name: "Joe Song", PPG: 2, teamName: "Overrated"},
    {name: "Juhyeong Mun", PPG: 0, teamName: "Overrated"},
    {name: "Matthew Li", PPG: 3, teamName: "Overrated"},
